...
export default function PartnerServices({ locale }: PartnerServicesProps) {
  ...
  return (
    <div className="px-4 py-4" dir="ltr" style={{ direction: 'ltr' }}>
      <h2 className="text-lg font-semibold text-gray-800 mb-3 text-left">{t.partnerServices}</h2>
      ...
      <div className="grid grid-cols-2 gap-3" dir="ltr">
        ...
        >
          <CardContent className={`p-2 relative flex flex-col ${locale === 'ar' ? 'items-end' : 'items-start'}`}>
            ...
            <h3 className={`font-semibold text-gray-800 mb-1 text-sm ${locale === 'ar' ? 'text-right' : 'text-left'}`}>
              {t.cleaningServices}
            </h3>
            <p className={`text-xs text-gray-600 ${locale === 'ar' ? 'text-right' : 'text-left'}`}>
              {t.cleaningServicesDescription}
            </p>
