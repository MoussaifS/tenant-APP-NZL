      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className="text-gray-400 hover:text-gray-600 active:text-gray-800 transition-colors p-2 absolute top-4 right-4 touch-manipulation rounded-full hover:bg-gray-100 active:bg-gray-200"
            style={{ 
